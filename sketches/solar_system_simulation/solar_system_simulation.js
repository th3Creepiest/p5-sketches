...
// https://github.com/michaelruppe/art/tree/master?tab=readme-ov-file

let planets = []
let sun
let numPlanets = 4
let G = 120
let destabilize = 0.15
...
function setup() {
  ...
  for (let i = 0; i < numPlanets; i++) {
    ...
    planetVel.mult(random(1 - destabilize, 1 + destabilize)) // create elliptical orbit
